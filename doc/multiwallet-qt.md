...
In order to support loading of multiple wallets in mintworldcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mintworldcoin.cpp.
...
Changes to mintworldcoin.cpp
----------------------
mintworldcoin.cpp is the entry point into mintworldcoin-qt, and as such, will require some minor modifications to provide hooks for
