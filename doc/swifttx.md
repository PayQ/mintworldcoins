...
This mechanism has been integrated into Bitcore-Node-MintWorldCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MintWorldCoin-Project/insight-api-mintworldcoin#web-socket-api](https://github.com/MintWorldCoin-Project/insight-api-mintworldcoin#web-socket-api) 
* API: [https://github.com/MintWorldCoin-Project/insight-api-mintworldcoin#swifttx-transactions](https://github.com/MintWorldCoin-Project/insight-api-mintworldcoin#swifttx-transactions) 
...
By default, the MintWorldCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MintWorldCoin Core daemon:
