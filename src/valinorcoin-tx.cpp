...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mintworldcoin Core mintworldcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mintworldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mintworldcoin transaction") + "\n" +
                               "  mintworldcoin-tx [options] -create [commands]   " + _("Create hex-encoded mintworldcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mintworldcoin transaction
