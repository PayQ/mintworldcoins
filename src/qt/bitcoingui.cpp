                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MintWorldCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MintWorldCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mintworldcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MintWorldCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MintWorldCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MintWorldCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MintWorldCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MintWorldCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MintWorldCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MintWorldCoin Core help message to get a list with possible MintWorldCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MintWorldCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MintWorldCoin network", "", count));
}
...
{
    QString strTitle = tr("MintWorldCoin Core"); // default title
