...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MintWorldCoin Core"),
     ...
     * override -datadir in the mintworldcoin.conf file in the default data directory
     * (to be consistent with mintworldcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
