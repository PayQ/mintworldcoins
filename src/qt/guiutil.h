...
/** Utility functions used by the MintWorldCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MintWorldCoin addresses in monospace font
...
// Parse "mintworldcoin:" URI into recipient object, return true on successful parsing
