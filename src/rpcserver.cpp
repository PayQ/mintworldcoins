...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MintWorldCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MintWorldCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mintworldcoin features */
        {"mintworldcoin", "masternode", &masternode, true, true, false},
        {"mintworldcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mintworldcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mintworldcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mintworldcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mintworldcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mintworldcoin", "startmasternode", &startmasternode, true, true, false},
        {"mintworldcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mintworldcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mintworldcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mintworldcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mintworldcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mintworldcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mintworldcoin", "mnbudget", &mnbudget, true, true, false},
        {"mintworldcoin", "preparebudget", &preparebudget, true, true, false},
        {"mintworldcoin", "submitbudget", &submitbudget, true, true, false},
        {"mintworldcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mintworldcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mintworldcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mintworldcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mintworldcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mintworldcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mintworldcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mintworldcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mintworldcoin", "mnsync", &mnsync, true, true, false},
        {"mintworldcoin", "spork", &spork, true, true, false},
        {"mintworldcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mintworldcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mintworldcoind, or the -server option to mintworldcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mintworldcoin-cli " + methodname + " " + args + "\n";
}
