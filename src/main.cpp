...
#if defined(NDEBUG)
#error "MintWorldCoin cannot be compiled without assertions."
#endif
...
unsigned int nCoinCacheSize = 10000;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	else if (nHeight <= 3999999 && nHeight >= 3000000) {
        ret = blockValue * 0.90;
    }
...
{
    RenameThread("mintworldcoin-scriptch");
...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    int64_t nBIP16SwitchTime = 1139,69,19238400;
